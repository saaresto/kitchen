...
class AdminBookingController(private val bookingService: BookingService) {
    ...
    fun pendingBookings(
        ...
        model.addAttribute("content", "admin/pending-bookings :: content")
        
        return "admin/layout"
    }

    @GetMapping("/today")
    fun todayBookings(model: Model): String {
        val bookings = bookingService.getTodayBookings()
        
        model.addAttribute("bookings", bookings)
        model.addAttribute("activeTab", "today")
        model.addAttribute("content", "admin/today-bookings :: content")
    ...
    fun bookingHistory(
        ...
        val bookings = allBookings.drop(currentPage * pageSize).take(pageSize)
        ...
        model.addAttribute("content", "admin/booking-history :: content")
